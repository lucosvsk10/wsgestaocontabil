...
Deno.serve(async req=>{
  ...
  try{
    ...
    const regime=String(p.tax_regime||"").toLowerCase(),isMei=regime.includes("mei"),isMeEpp=regime.includes("simples")&&!isMei,isSimples=isMei||isMeEpp;
