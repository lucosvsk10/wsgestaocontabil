...
serve(async (req) => {
  ...
  try {
    ...
    return json({
      ...
      chaveAcesso: parsed.protocol.chNFe || built.chaveAcesso,
      total: built.total,
      idLote: authResult.idLote,
