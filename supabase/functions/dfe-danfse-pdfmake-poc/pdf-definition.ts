...
const BLACK="#080808",MID="#737373",GRAY="#f2f2f2";
...
export function buildDanfseDefinition(d:DanfseData){
  ...
  const canvas:any[]=[
    ...
    {type:"rect",x:5.5,y:126,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:5.5,y1:126,x2:589.5,y2:126,lineWidth:.5,lineColor:BLACK},{type:"line",x1:152,y1:126,x2:152,y2:203,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:126,x2:296,y2:203,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:126,x2:441,y2:203,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:203,x2:589.5,y2:203,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:203,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:203,x2:152,y2:267,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:203,x2:296,y2:267,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:203,x2:441,y2:267,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:267,x2:589.5,y2:267,lineWidth:.5,lineColor:BLACK},{type:"line",x1:5.5,y1:268.5,x2:589.5,y2:268.5,lineWidth:.5,lineColor:BLACK},{type:"line",x1:5.5,y1:277.5,x2:589.5,y2:277.5,lineWidth:.5,lineColor:BLACK},{type:"line",x1:5.5,y1:286.5,x2:589.5,y2:286.5,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:286.5,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:286.5,x2:152,y2:438,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:286.5,x2:296,y2:317,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:286.5,x2:441,y2:317,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:438,x2:589.5,y2:438,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:438,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:438,x2:152,y2:478,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:438,x2:296,y2:478,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:438,x2:441,y2:478,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:478,x2:589.5,y2:478,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:478,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:478,x2:152,y2:518,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:478,x2:296,y2:518,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:478,x2:441,y2:498,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:518,x2:589.5,y2:518,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:518,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:518,x2:152,y2:602,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:518,x2:296,y2:602,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:518,x2:441,y2:602,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:602,x2:589.5,y2:602,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:602,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:152,y1:602,x2:152,y2:642,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:602,x2:296,y2:642,lineWidth:.5,lineColor:MID},{type:"line",x1:441,y1:602,x2:441,y2:642,lineWidth:.5,lineColor:MID},{type:"rect",x:441,y:622,w:148.5,h:20,lineWidth:0,color:GRAY},{type:"line",x1:5.5,y1:642,x2:589.5,y2:642,lineWidth:.5,lineColor:BLACK},
    {type:"rect",x:5.5,y:642,w:584,h:11,lineWidth:0,color:GRAY},{type:"line",x1:5.5,y1:811,x2:589.5,y2:811,lineWidth:.5,lineColor:BLACK},{type:"line",x1:151,y1:811,x2:151,y2:833,lineWidth:.5,lineColor:MID},{type:"line",x1:296,y1:811,x2:296,y2:833,lineWidth:.5,lineColor:MID},{type:"line",x1:5.5,y1:833,x2:589.5,y2:833,lineWidth:.5,lineColor:BLACK}
  ];
  ...
  content.push({qr:d.qrValue,fit:50.1,absolutePosition:{x:493,y:40.9},margin:[0,0,0,0]});
  ...
  add(content,field(11,172.6,280,"Endereço",oneLine(d.prestador.address,80),{valueSize:6.4}));add(content,field(301,172.6,130,"E-mail",oneLine(d.prestador.email,40),{valueSize:6.2}));
  ...
  add(content,field(11,249.6,280,"Endereço",oneLine(d.tomador.address,80),{valueSize:6.4}));add(content,field(301,249.6,135,"E-mail",oneLine(d.tomador.email,44),{valueSize:6.2}));
  ...
  content.push(boxed(oneLine(d.service.classification,220),11,309.5,275,6,false,{lineHeight:1.08}),txt("Descrição do Serviço",11,325.6,5.8,true),boxed(oneLine(d.service.description,420),11,336.5,280,6,false,{lineHeight:1.08}));
  ...
  return {pageSize:{width:595,height:842},pageMargins:[0,0,0,0],defaultStyle:{font:"Helvetica",fontSize:6,color:BLACK,lineHeight:1},content};
}