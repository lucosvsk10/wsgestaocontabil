...
async function recoverSpNfe55Numbers(){
  return {skipped:true,reason:"disabled_after_unexpected_authorization_guard",processed:0,found:0,cancelled:0,unused:0,failed:0,pending:0,complete:false,cooldown:false,probe_validated:false,scopes:[],failures:[]};
}
