...
export interface PayrollEntry { id: string; date: string; history: string; eventType?: string; debitCode: string; debitDescription: string; debitCostCenter: string; creditCode: string; creditDescription: string; creditCostCenter: string; amountInCents: number; source?: string; confidence?: number; }
...
export interface PayrollProcessingMeta { model: string; primaryModel: string; reviewed: boolean; reviewModel?: string | null; }
