...
const AppRoutes=()=>{
 ...
 return <Routes>
  ...
  <Route path="/admin/clientes" element={<PrivateRoute requiredRole="admin"><AdminCompanies/></PrivateRoute>}/><Route path="/admin/clientes/:companyId" element={<PrivateRoute requiredRole="admin"><AdminClientProfile/></PrivateRoute>}/><Route path="/admin/clientes/:companyId/fiscal" element={<PrivateRoute requiredRole="admin"><AdminClientFiscalSetup/></PrivateRoute>}/><Route path="/admin/empresas" element={<Navigate to="/admin/clientes" replace/>}/>
  <Route path="/admin/documentos" element={<PrivateRoute requiredRole="admin"><AdminClientDocuments/></PrivateRoute>}/><Route path="/admin/users" element={<Navigate to="/admin/documentos" replace/>}/><Route path="/admin/user-documents/:userId" element={<PrivateRoute requiredRole="admin"><AdminDashboard activeTab="user-documents"/></PrivateRoute>}/><Route path="/admin/company-data/:userId" element={<PrivateRoute requiredRole="admin"><CompanyDataView/></PrivateRoute>}/>
  ...
  <Route path="/client/*" element={<PrivateRoute><ClientDashboard/></PrivateRoute>}/><Route path="/dashboard" element={<PrivateRoute>{isAdmin()?<Navigate to="/admin" replace/>:<Navigate to="/client" replace/>}</PrivateRoute>}/><Route path="*" element={<NotFound/>}/>
 </Routes>;
};
