  ...
  return (
    <div className="min-h-screen flex flex-col bg-orange-200 dark:bg-navy-dark">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md border-gold/20 bg-white dark:bg-[#393532] rounded-md">
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <Input 
                    ...
                    required 
                    className="pl-10 bg-white dark:bg-[#46413d] border-gray-300 dark:border-gray-700" 
                  />
                </div>
              </div>
              <div className="space-y-2">
