            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <Input type={showPassword ? "text" : "password"} id="password" placeholder="●●●●●●" value={password} onChange={e => setPassword(e.target.value)} className="pl-10 border-white -500 bg-[#46413d]" />
