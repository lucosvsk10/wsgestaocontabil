      ...
      <div className="container mx-auto px-4 py-[100px] print:py-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 font-extralight print:text-gray-600 print:text-base">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Formulário */}
            <Card className="bg-white/50 dark:bg-[#0b1320]/50 border-[#efc349]/20 backdrop-blur-sm print:bg-white print:border-gray-300">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label htmlFor="rendimentoBruto" className="text-white font-extralight flex items-center print:text-black">
                ...
                <div>
                  <Label htmlFor="inss" className="text-white font-extralight flex items-center print:text-black">
                ...
                <div>
                  <Label htmlFor="dependentes" className="text-white font-extralight flex items-center print:text-black">
                ...
                <div>
                  <Label htmlFor="educacao" className="text-white font-extralight flex items-center print:text-black">
                  ...
                  <Input 
                    ...
                    className="bg-[#020817] border-[#efc349]/30 text-white mt-1 print:bg-white print:border-gray-300 print:text-black" 
                  />
                  <p className="text-xs text-gray-400 mt-1 print:text-gray-600">Limite: R$ 3.561,50 por dependente</p>
                </div>

                <div>
                  <Label htmlFor="saude" className="text-white font-extralight flex items-center print:text-black">
                  ...
                  <Input 
                    ...
                    className="bg-[#020817] border-[#efc349]/30 text-white mt-1 print:bg-white print:border-gray-300 print:text-black" 
                  />
                  <p className="text-xs text-gray-400 mt-1 print:text-gray-600">Sem limite de valor</p>
                </div>

                <div>
                  <Label htmlFor="outrasDeducoes" className="text-white font-extralight print:text-black">
                    Outras Deduções (R$)
                  </Label>
                  <Input 
                    id="outrasDeducoes" 
                ...
                <Card className="bg-white/50 dark:bg-[#0b1320]/50 border-[#efc349]/20 backdrop-blur-sm print:bg-white print:border-gray-300">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                      <div className="bg-[#020817] rounded-lg p-4 print:bg-gray-50 print:border print:border-gray-300">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Rendimento Bruto:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.rendimentoBruto)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Total de Deduções:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.totalDeducoes)}</span>
                          </div>
                          <div className="flex justify-between border-t border-[#efc349]/20 pt-2 print:border-gray-300">
                            <span className="text-gray-400 print:text-gray-600">Base de Cálculo:</span>
                            <span className="text-white font-medium print:text-black">{formatCurrency(resultado.baseCalculo)}</span>
                          </div>
                        </div>
                      </div>

                      <div className="bg-[#020817] rounded-lg p-4 print:bg-gray-50 print:border print:border-gray-300">
                        <h3 className="text-lg font-medium text-white mb-3 print:text-black">Imposto</h3>
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Alíquota Efetiva:</span>
                          ...
                          <div className="flex justify-between border-t border-[#efc349]/20 pt-2 print:border-gray-300">
                            <span className="text-gray-400 print:text-gray-600">Imposto Devido:</span>
                      ...
                      <div className="bg-[#020817] rounded-lg p-4 print:bg-gray-50 print:border print:border-gray-300">
                        <h3 className="text-lg font-medium text-white mb-3 print:text-black">Deduções Utilizadas</h3>
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">INSS:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.inss)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Dependentes ({resultado.dependentes}):</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.dependentes * 2275.08)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Educação:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.educacao)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Saúde:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.saude)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400 print:text-gray-600">Outras:</span>
                            <span className="text-white print:text-black">{formatCurrency(resultado.outrasDeducoes)}</span>
                          </div>
                        </div>
                      </div>
                    </div>
