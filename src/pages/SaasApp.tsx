...
export default function SaasApp() {
  ...
  return <div className="saas-admin-light min-h-screen bg-background text-foreground" style={lightVars}>
    ...
    <aside className="fixed bottom-0 left-0 top-[72px] z-50 flex w-72 flex-col border-r border-border bg-white">
      <div className="border-b border-border px-5 py-4"><button onClick={() => setActive("Minha Empresa")} className="mx-auto flex h-40 w-40 items-center justify-center overflow-hidden rounded-xl border border-border bg-[#f7f8fa] p-5 transition hover:bg-[#f1f3f6]">{logoUrl ? <img src={logoUrl} alt="Logo da empresa" className="max-h-[112px] max-w-[112px] object-contain" /> : <span className="text-center text-xs font-medium text-muted-foreground">Adicionar logomarca</span>}</button></div>
