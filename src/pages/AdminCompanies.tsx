...
export default function AdminCompanies(){
 ...
 return <AdminLayout><AdminPage className="ws-admin-polish">
   <AdminPageHeader eyebrow="Clientes" title="Clientes" description="Gerencie os clientes do escritório e, em uma aba separada, os assinantes do emissor fiscal." actions={<Button className="ws-stage4-primary-action" onClick={()=>setOpen(true)}><Plus className="mr-2 h-4 w-4"/>Novo cliente</Button>}/>
