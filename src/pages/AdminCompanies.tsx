...
export default function AdminCompanies(){
 ...
 return <AdminLayout><AdminPage className="ws-admin-polish">
   <AdminPageHeader eyebrow="Clientes do escritório" title="Clientes" description="Cada empresa existe uma única vez no sistema. Clique em uma empresa para abrir seu cadastro completo." actions={<Button className="ws-stage4-primary-action" onClick={()=>setOpen(true)}><Plus className="mr-2 h-4 w-4"/>Novo cliente</Button>}/>
