...
import { LayoutDashboard, FileText, PieChart, Calculator, Settings, Wrench, HardDrive, Megaphone, Calendar, Images, FileStack, LucideIcon, Building2, ReceiptText, Send, UsersRound } from "lucide-react";
...
export const useAdminSidebarNavigation=()=>{
 ...
 const sidebarSections:SidebarSection[]=[
  ...
  {title:'SaaS',items:[{icon:UsersRound,label:'Assinantes',active:active('/admin/assinantes'),to:'/admin/assinantes'}]},
