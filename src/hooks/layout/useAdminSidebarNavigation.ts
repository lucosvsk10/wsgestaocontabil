...
export const useAdminSidebarNavigation=()=>{
 ...
 const sidebarSections:SidebarSection[]=[
  ...
  {title:'Fiscal',items:[{icon:ReceiptText,label:'Extrator Fiscal',active:false,to:'/extrator?source=admin'},{icon:Send,label:'Emissor Fiscal',active:false,to:'/app?source=admin'}]},
