...
const ToolsSection = () => {
  ...
  return <section id="ferramentas" className="py-20 bg-white dark:bg-[#020817]">
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          <h2 className="text-4xl font-extralight text-[#020817] dark:text-[#efc349] mb-6 md:text-4xl">
            FERRAMENTAS
          </h2>
          ...
          once: true
              ...
              <Card className="h-full hover:shadow-lg transition-all duration-300 bg-transparent border-[#efc349]/20 hover:border-[#efc349]/40">
                ...
                <CardContent className="text-center">
                  ...
                  <Button onClick={() => navigate(tool.route)} className="w-full bg-[#efc349] hover:bg-[#efc349]/90 text-[#020817] font-extralight">
                    Acessar Ferramenta
                  </Button>
                </CardContent>
              </Card>
