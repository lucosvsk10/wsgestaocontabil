...
export const AdminDocumentManager: React.FC<AdminDocumentManagerProps> = ({
  ...
  const uncategorizedDocuments = sortedDocuments.filter(
    doc => !doc.category || !categories.some(cat => cat.id === doc.category)
  );
            ...
            <Card className="border border-gray-200 dark:border-navy-lighter/30 bg-white dark:bg-navy-deeper shadow-sm">
              <CardHeader className="pb-3">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <CardTitle className="text-navy-dark dark:text-gold text-xl">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                      ...
                      <Input
                        ...
                        className="pl-9 border-gray-200 dark:border-navy-lighter/30 dark:bg-navy-light/10"
                      />
                    </div>
                    ...
                    <select
                      ...
                      className="h-10 rounded-md border border-gray-200 dark:border-navy-lighter/30 dark:bg-navy-light/10 dark:text-white px-3"
                    >
                    ...
                    <Button 
                      ...
                      className="border-gray-200 dark:border-navy-lighter/30"
                    >
              ...
              <CardContent className="p-6 pt-0">
                <div className="hidden md:block">
                  ...
                  {uncategorizedDocuments.length > 0 && (
                    <DocumentCategoryGroup
                      key="uncategorized"
                      category={{ id: "uncategorized", name: "Sem categoria", color: "#6B7280", created_at: "", updated_at: "" }}
                  ...
                  {sortedDocuments.length === 0 && !isLoadingDocuments && (
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent className="bg-white dark:bg-navy-deeper">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction 
              className="bg-red-600 text-white hover:bg-red-700 dark:bg-red-600/90 dark:hover:bg-red-600"
              onClick={() => {
                if (documentToDelete) {
