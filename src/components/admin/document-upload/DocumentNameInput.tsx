  ...
  return (
    <div>
      ...
      <Input
        ...
        className="mt-1 border-gray-300 dark:border-navy-lighter/40 focus:ring-navy dark:focus:ring-gold/70 focus:border-navy dark:focus:border-gold/70 dark:bg-navy-deeper dark:text-white dark:placeholder-gray-300"
