...
interface CreateUserProps {
  onUserCreated: (data: UserFormData) => void;
  isCreating: boolean;
}
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-navy hover:bg-navy-light text-white dark:bg-gold dark:hover:bg-gold-light dark:text-navy" disabled={isCreating}>
              {isCreating ? (
