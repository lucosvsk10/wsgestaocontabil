...
export const AdminDashboardView = ({ 
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold mb-6 text-navy-dark dark:text-gold font-museo">Dashboard</h2>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <SystemSummary 
            ...
            storageUsed={storageStats ? `${storageStats.totalStorageMB.toFixed(2)} MB` : 'Calculando...'}
            appVersion="1.0.0"
          />
          ...
          <RecentDocumentsTable 
            ...
            formatRecentDate={formatRecentDate} 
          />
        </>
      )}
    </div>
