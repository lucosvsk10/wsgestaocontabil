                ...
                {!isAdmin && (
                  <TableCell>
                    <div className="flex gap-2 flex-wrap">
                      <Button 
                        size="sm" 
                        className="bg-[#020817] border border-[#efc349] text-white dark:bg-transparent dark:border-[#efc349] dark:text-[#efc349] hover:bg-[#0f172a] dark:hover:bg-[#efc349]/10 font-extralight"
                      ...
                      <Button 
                        size="sm" 
                        className="bg-[#020817] border border-red-400 text-white dark:bg-transparent dark:border-red-400 dark:text-red-400 hover:bg-red-600 dark:hover:bg-red-400/10 font-extralight"
    ...
    <div className="min-h-screen bg-[#fdfdfd] dark:bg-[#020817] p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Button 
          ...
          className="fixed bottom-8 right-8 h-14 w-14 rounded-full bg-[#020817] border-2 border-[#efc349] text-white dark:bg-transparent dark:border-[#efc349] dark:text-[#efc349] hover:bg-[#0f172a] dark:hover:bg-[#efc349]/10 shadow-lg z-50" 
          size="icon"
        >
