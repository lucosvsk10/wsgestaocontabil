...
export const PollsTabView = () => {
  ...
  return <Tabs defaultValue="create" className="space-y-4">
      <TabsList className="grid w-full grid-cols-3 bg-gray-100 dark:bg-navy-deeper">
        <TabsTrigger value="create" className="text-white dark:text-white data-[state=active]:bg-white data-[state=active]:text-navy-dark dark:data-[state=active]:bg-navy-medium">
          Criar nova enquete
        </TabsTrigger>
