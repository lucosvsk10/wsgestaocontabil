...
const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <aside 
      data-sidebar="true" 
      className={`w-72 flex flex-col transition-all duration-300 ease-in-out bg-white dark:bg-[#020817] ${
        open ? "translate-x-0" : "-translate-x-0 md:translate-x-0 md:w-20"
      } ${isMobile ? "fixed inset-y-0 z-40 shadow-2xl" : ""}`}
    >
      {/* Logo area */}
      <div className="h-20 flex items-center justify-center px-6 border-b border-gray-100 dark:border-[#efc349]/20">
