...
const AccountingSection = () => {
  ...
  return (
    <section id="contabil" className="py-16 bg-navy px-6 fadein-on-scroll">
      <div className="container mx-auto">
        <h2 className="text-3xl font-anton text-gold mb-12 text-center">MUNDO CONTÁBIL</h2>
          ...
          <TabsContent value="links">
            ...
            <div className="fixed bottom-8 right-8 z-30">
              {isFloatingButtonOpen ? (
                <div className="bg-navy-dark border border-gold/30 rounded-lg p-4 shadow-lg mb-4 animate-fade-in">
                  ...
                  <div className="space-y-2">
                    {usefulLinks.map((link) => (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="block text-white hover:text-gold transition-colors p-2 hover:bg-navy-light rounded"
                      >
                        {link.title}
                      </a>
                    ))}
              ...
              <Button 
                size="icon" 
                className="h-12 w-12 rounded-full bg-gold hover:bg-gold-light text-navy shadow-lg"
