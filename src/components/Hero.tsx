...
const Hero = () => {
  ...
  return <section id="hero" className="relative min-h-screen pt-24 flex items-center justify-center overflow-hidden bg-navy py-0">
      ...
      <div ref={heroRef} className="container relative z-5 transition-all duration-700 transform opacity-0 translate-y-10 py-[240px] px-10 my-[240px] mx-[240px]">
        <div className="border overflow-hidden backdrop-blur-sm p-8 md:p-12 border-[5px] border-[#efc349] rounded-lg my-[240px] py-[240px] mx-[2px] px-[50px]">
