...
const Hero = () => {
  ...
  return <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden py-0 bg-white dark:bg-navy-dark">
      ...
      <div ref={heroRef} className={`container relative z-5 transition-all duration-700 transform opacity-0 translate-y-0 flex items-center justify-center px-[10px] ${isMobile ? 'mt-[-50px]' : 'my-[50px]'}`}>
