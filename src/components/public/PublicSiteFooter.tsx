  ...
  <>
    <footer className="public-footer">
      <div className="public-footer-cta">
        <div><span>NÃO DEIXE A CONTABILIDADE VIRAR UM PROBLEMA.</span><h2>Coloque sua empresa nas mãos de quem acompanha os números e resolve o que precisa ser resolvido.</h2></div>
      ...
      <div className="public-footer-grid">
        ...
        <div>
          ...
          <nav aria-label="Institucional">
            <a href="/home-preview">Página inicial</a>
            <a href="/home-preview#servicos">Serviços contábeis</a>
            <a href="/home-preview#empresas">Empresas que confiam</a>
            <a href="/home-preview#escritorio">Conheça o escritório</a>
            <a href="/home-preview#duvidas">Dúvidas frequentes</a>
          </nav>
        </div>
        ...
        <div>
          ...
          <nav aria-label="Soluções e conteúdo">
            ...
            <Link to="/extrator-fiscal">Extrator Fiscal</Link>
        ...
        <div>
          ...
          <a className="public-footer-contact" href="mailto:contato@wsgestaocontabil.com"><Mail /> contato@wsgestaocontabil.com</a>
          <a className="public-footer-location" href="https://maps.app.goo.gl/nCabkeuY39TkrYv59" target="_blank" rel="noreferrer"><MapPin /><span><strong>Sede</strong>Palmeira dos Índios — AL</span><Route /></a>
          <a className="public-footer-location" href="https://maps.app.goo.gl/cthtEGbJGqGBTVVo9" target="_blank" rel="noreferrer"><MapPin /><span><strong>Filial</strong>Major Isidoro — AL</span><Route /></a>
        </div>
      </div>
