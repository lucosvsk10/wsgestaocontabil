        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-white/70 dark:text-white/80 max-w-xs">
              Soluções contábeis completas para o sucesso do seu negócio. Conte com nossa expertise para cuidar da saúde
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gold/20">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center space-x-3">
                    <Mail className="w-5 h-5 text-gold flex-shrink-0" />
                    <span className="text-white/70 dark:text-white/80 text-sm">wsgestao.societario@outlook.com</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white dark:text-white">Segunda a Sexta</p>
                  <p className="text-white/70 dark:text-white/80">08:00 às 17:00</p>
                </div>
              </li>
            </ul>
            <div className="pt-4">
