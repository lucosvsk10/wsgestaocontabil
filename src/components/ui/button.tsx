  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-300 bg-white hover:bg-gray-50 hover:text-blue-700 dark:border-navy-lighter dark:bg-navy-medium dark:hover:bg-navy-lighter dark:hover:text-white",
        secondary:
        ...
        document: "bg-gold/20 text-navy hover:bg-gold/30 dark:bg-navy-medium dark:text-white dark:hover:bg-navy-lighter/90 border border-gold/40 dark:border-gold/20",
