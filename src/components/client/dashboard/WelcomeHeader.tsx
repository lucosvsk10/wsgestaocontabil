  ...
  return <motion.div initial={{
    ...
    duration: 0.6
      ...
      <div className="flex items-center justify-between">
        <div className="bg-white dark:bg-deepNavy/60 border border-[#e6e6e6] dark:border-gold/30 rounded-xl p-6 transition-all duration-500 fadein-on-scroll shadow-sm hover:shadow-md">
