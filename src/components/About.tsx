...
import { Briefcase, Calculator, Settings, Users } from 'lucide-react';

const services = [{
  title: "Abertura, alteração e baixa de empresas",
  description: "Serviços completos para formalização, modificação e encerramento de empresas com agilidade e segurança jurídica.",
  icon: <Briefcase className="w-10 h-10 text-gold" />
}, {
  title: "Planejamento tributário inteligente",
  description: "Estratégias personalizadas para redução legal da carga tributária e otimização dos resultados financeiros da sua empresa.",
  icon: <Calculator className="w-10 h-10 text-gold" />
}, {
  title: "Gestão empresarial",
  description: "Consultoria especializada para aprimorar processos internos, aumentar produtividade e garantir conformidade regulatória.",
  icon: <Settings className="w-10 h-10 text-gold" />
}, {
  title: "Assessoria trabalhista",
  description: "Suporte completo em relações trabalhistas, folha de pagamento, admissões, demissões e obrigações acessórias.",
