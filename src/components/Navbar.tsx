...
const Navbar = () => {
  ...
  return <header className="bg-white dark:bg-[#46413d] text-navy dark:text-white">
      <div className="container mx-auto flex items-center justify-between px-[28px] py-[19px] bg-orange-200">
        <Logo />
