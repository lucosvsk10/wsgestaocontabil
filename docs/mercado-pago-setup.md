# Ativação do Mercado Pago na WS
...
- `MERCADO_PAGO_WEBHOOK_SECRET`: assinatura secreta gerada na configuração do webhook.
- `MERCADO_PAGO_SELLER_EMAIL`: e-mail da conta vendedora, usado para impedir autopagamento.
